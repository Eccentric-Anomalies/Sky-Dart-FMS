...
\ LANDING PAD LOCAL SIGNAL
    ...
    7F000000 CONSTANT MASK_PADL_MSG
    ...
    08 CONSTANT PADL_ORE  \ kg/100

\ LANDING GEAR FOOT STATUS CHANGE
    7F000000 CONSTANT MASK_FOOT_ID
...
\
    ...
    07 CONSTANT PORT_ORE_CAPACITY
    08 CONSTANT PORT_ORE_QTY
    09 CONSTANT PORT_MSG
    10 CONSTANT PORT_BUTTON_LANDING_LIGHT

\ === OUTPUTS ===
\ LIGHTS
    01 CONSTANT PORT_LANDING_LIGHT
    02 CONSTANT PORT_WARNING
    03 CONSTANT PORT_MESSAGE_LIGHT
\ TRANSFER STATE CHANGES
    13 CONSTANT PORT_RSRC_DIRECTION   \ SHIP_TO_PAD or PAD_TO_SHIP
    14 CONSTANT PORT_PROP_XFER_STATE
    15 CONSTANT PORT_REPAIR_XFER_STATE
    16 CONSTANT PORT_ORE_XFER_STATE  \ e.g. Scheelite
